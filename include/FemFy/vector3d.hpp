...
class vec3d {
 public:
  ...
  T dot(const vec3d<T>& obj) {
    return coord[0] * obj.coord[0] + coord[1] * obj.coord[1] +
           coord[2] * obj.coord[2];
  }

  vec3d<T> cross(const vec3d<T>& obj) {
    return vec3d<T>(coord[1] * obj.coord[2] - coord[2] * obj.coord[1],
                    coord[2] * obj.coord[0] - coord[0] * obj.coord[2],
                    coord[0] * obj.coord[1] - coord[1] * obj.coord[0]);
  }
 ...
 */
template <typename T>
T norm(const vec3d<T>& obj) {
  return std::sqrt(obj.coord[0] * obj.coord[0] + obj.coord[1] * obj.coord[1] +
                   obj.coord[2] * obj.coord[2]);
}
